  ...
  return (
    <Fragment>
      ...
      <div className="h-screen w-screen relative">
        {/* Content wellcome */}
        <div className='absolute inset-0 z-10 my-32 mx-40 flex'>
          <div >
            <p className='text-8xl font-bold text-white mb-6 animate__animated animate__fadeInDownBig'>Travel <br />to Share</p>
            <p className='w-7/12 text-gray-200 mb-10 animate__animated animate__fadeInRight'>Let us help you find great vacation Places and we will provide famous and popular tourist Places all over the world</p>
            <Link href={isSignin ? '/place' : '/login'} className='font-bold text-white  px-7 py-3 rounded-2xl bg-sky-600 hover:bg-sky-300 animate__animated animate__fadeInLeft'>Get Started</Link>
          </div>
        </div>
        <video
